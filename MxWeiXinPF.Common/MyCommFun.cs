...
namespace MxWeiXinPF.Common
{
    public class MyCommFun
    {
        ...
        public static string getWebSite()
        {
            ...
            //发布的项目名称
            if (ConfigurationManager.AppSettings["ProductName"]!=null && ConfigurationManager.AppSettings["ProductName"].ToString().Trim()!="")
            {
                website += "/" + ConfigurationManager.AppSettings["ProductName"].ToString().Trim();
            }
            return website;
        }
