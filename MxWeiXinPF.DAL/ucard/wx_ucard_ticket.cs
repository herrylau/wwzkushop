	...
	public partial class wx_ucard_ticket
	{
        ...
        public int Add(MxWeiXinPF.Model.wx_ucard_ticket model)
        {
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@usedTimes", SqlDbType.Int,8),
					new SqlParameter("@userDegree", SqlDbType.VarChar,500),
					new SqlParameter("@userType", SqlDbType.Int,8),
					new SqlParameter("@consumeMoney", SqlDbType.Int,8),
					new SqlParameter("@sId", SqlDbType.Int,8),
					new SqlParameter("@dyMoney", SqlDbType.Int,8),
        ...
        public string getUserTicketStr(int sid, int uid, int degreeNum, decimal ttcMoney)
        {
            ...
            SqlParameter[] parameters = {
                    ...
                    new SqlParameter("@degreeNum",SqlDbType.Int,8),
        ...
        public int getsyTimesByTicket(int uid, int ticketId)
        {
            ...
            SqlParameter[] parameters = {
                    new SqlParameter("@uid",SqlDbType.Int,8),
					new SqlParameter("@ticketId", SqlDbType.Int,8)
			};
