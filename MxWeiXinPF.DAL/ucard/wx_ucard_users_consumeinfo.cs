    ...
    public partial class wx_ucard_users_consumeinfo
    {
        ...
        public bool Update(MxWeiXinPF.Model.wx_ucard_users_consumeinfo model)
        {
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@moduleTypeId", SqlDbType.Int,8),
					new SqlParameter("@moduleActionName", SqlDbType.VarChar,200),
					new SqlParameter("@moduleActionId", SqlDbType.Int,8),
					new SqlParameter("@cScoreType", SqlDbType.Int,8),
					new SqlParameter("@score", SqlDbType.Int,8),
					new SqlParameter("@cMoneyType", SqlDbType.Int,8),
        ...
        public int Add(MxWeiXinPF.Model.wx_ucard_users_consumeinfo model,bool isXiaoFei)
        {
            ...
            SqlParameter[] parameters2 = {
					new SqlParameter("@newscore", SqlDbType.Int,8),
            ...
            using (SqlConnection conn = new SqlConnection(DbHelperSQL.connectionString))
            {
                ...
                using (SqlTransaction trans = conn.BeginTransaction())
                {
					...
					new SqlParameter("@id", SqlDbType.Int,8)};
                        ...
                        SqlParameter[] parameters2 = {
                    new SqlParameter("@oldscore", SqlDbType.Int,8),
					new SqlParameter("@newscore", SqlDbType.Int,8),
