	...
	public partial class wx_ucard_users
	{
		...
		public bool Update(MxWeiXinPF.Model.wx_ucard_users model)
		{
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@degreeId", SqlDbType.Int,8),
					new SqlParameter("@sex", SqlDbType.Int,8),
					...
					new SqlParameter("@ttScore", SqlDbType.Int,8),
					new SqlParameter("@qdScore", SqlDbType.Int,8),
					new SqlParameter("@consumeScore", SqlDbType.Int,8),
