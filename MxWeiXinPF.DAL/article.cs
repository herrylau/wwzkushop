...
namespace MxWeiXinPF.DAL
{
    ...
    public partial class article
    {
        ...
        public int Add(Model.article model)
        {
            ...
            SqlParameter[] parameters = {
					new SqlParameter("@channel_id", SqlDbType.Int,8),
					new SqlParameter("@category_id", SqlDbType.Int,8),
                    new SqlParameter("@call_index", SqlDbType.NVarChar,50),
					...
					new SqlParameter("@click", SqlDbType.Int,8),
					new SqlParameter("@status", SqlDbType.TinyInt,1),
					new SqlParameter("@groupids_view", SqlDbType.NVarChar,255),
					new SqlParameter("@vote_id", SqlDbType.Int,8),
            ...
            if (model.attach != null)
            {
                ...
                foreach (Model.article_attach modelt in model.attach)
                {
                    ...
                    SqlParameter[] parameters4 = {
					        ...
					        new SqlParameter("@file_size", SqlDbType.Int,8),
					        new SqlParameter("@file_ext", SqlDbType.NVarChar,20),
					        new SqlParameter("@down_num", SqlDbType.Int,8),
					        new SqlParameter("@point", SqlDbType.Int,8)};
            ...
            if (model.group_price != null)
            {
                ...
                foreach (Model.user_group_price models in model.group_price)
                {
                    ...
                    SqlParameter[] parameters5 = {
						    new SqlParameter("@article_id", SqlDbType.Int,8),
					        new SqlParameter("@group_id", SqlDbType.Int,8),
