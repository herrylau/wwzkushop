    ...
    public partial class orders
    {
        ...
        public int Add(Model.orders model)
        {
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@payment_id", SqlDbType.Int,8),
					...
					new SqlParameter("@express_id", SqlDbType.Int,8),
					...
					new SqlParameter("@modelActionId", SqlDbType.Int,8),
            ...
            if (model.order_goods != null)
            {
                ...
                foreach (Model.order_goods models in model.order_goods)
                {
                    ...
                    SqlParameter[] parameters2 = {
						    new SqlParameter("@order_id", SqlDbType.Int,8),
						    new SqlParameter("@goods_id", SqlDbType.Int,8),
						    ...
						    new SqlParameter("@quantity", SqlDbType.Int,8),
						    new SqlParameter("@point", SqlDbType.Int,8)};
