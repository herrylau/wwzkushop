	...
	public partial class wx_templates_wcode
	{
		...
		public int Add(MxWeiXinPF.Model.wx_templates_wcode model)
		{
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@tid", SqlDbType.Int,8),
					...
					new SqlParameter("@listTid", SqlDbType.Int,8),
					new SqlParameter("@detailTid", SqlDbType.Int,8),
					new SqlParameter("@channelTid", SqlDbType.Int,8),
					new SqlParameter("@bmenuTid", SqlDbType.Int,8),
					new SqlParameter("@topcolorTypeId", SqlDbType.Int,8),
