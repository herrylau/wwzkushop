...
namespace MxWeiXinPF.DAL
{
	...
	public partial class wx_userweixin
	{
		...
		public int Add(MxWeiXinPF.Model.wx_userweixin model)
		{
			...
			SqlParameter[] parameters = {
					new SqlParameter("@uId", SqlDbType.Int,8),
					...
					new SqlParameter("@wenziMaxNum", SqlDbType.Int,8),
					new SqlParameter("@tuwenMaxNum", SqlDbType.Int,8),
					new SqlParameter("@yuyinMaxNum", SqlDbType.Int,8),
					new SqlParameter("@wenziDefineNum", SqlDbType.Int,8),
					new SqlParameter("@tuwenDefineNum", SqlDbType.Int,8),
					new SqlParameter("@yuyinDefineNum", SqlDbType.Int,8),
					new SqlParameter("@requestTTNum", SqlDbType.Int,8),
					new SqlParameter("@requestUsedNum", SqlDbType.Int,8),
					new SqlParameter("@smsTTNum", SqlDbType.Int,8),
					new SqlParameter("@smsUsedNum", SqlDbType.Int,8),
					new SqlParameter("@isDelete", SqlDbType.Bit,1),
					new SqlParameter("@deleteDate", SqlDbType.DateTime),
					new SqlParameter("@wxType", SqlDbType.Int,8),
					new SqlParameter("@remark", SqlDbType.Text),
					new SqlParameter("@seq", SqlDbType.Int,8),
					...
					new SqlParameter("@extInt", SqlDbType.Int,8),
					new SqlParameter("@extInt2", SqlDbType.Int,8)};
