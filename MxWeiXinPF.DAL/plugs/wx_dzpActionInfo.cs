	...
	public partial class wx_dzpActionInfo
	{
		...
		public int Add(MxWeiXinPF.Model.wx_dzpActionInfo model)
		{
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@personNum", SqlDbType.Int,8),
					new SqlParameter("@personMaxTimes", SqlDbType.Int,8),
					new SqlParameter("@dayMaxTimes", SqlDbType.Int,8),
					...
					new SqlParameter("@aStatus", SqlDbType.Int,8),
