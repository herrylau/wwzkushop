...
namespace MxWeiXinPF.DAL
{
	...
	public partial class wx_diancai_member
	{
		...
		public int Add(MxWeiXinPF.Model.wx_diancai_member model)
		{
			...
			SqlParameter[] parameters = {
					new SqlParameter("@shopid", SqlDbType.Int,8),
					...
					new SqlParameter("@successDingdan", SqlDbType.Int,8),
					new SqlParameter("@failDingdan", SqlDbType.Int,8),
					new SqlParameter("@cancelDingdan", SqlDbType.Int,8),
					new SqlParameter("@status", SqlDbType.Int,8),
					new SqlParameter("@zongjifen", SqlDbType.Int,8),
