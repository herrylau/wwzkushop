	...
	public partial class wx_sjb_bisai
	{
		...
		public int Add(MxWeiXinPF.Model.wx_sjb_bisai model)
		{
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@rcId", SqlDbType.Int,8),
					new SqlParameter("@qd1Id", SqlDbType.Int,8),
					new SqlParameter("@qd2Id", SqlDbType.Int,8),
					new SqlParameter("@beginDate", SqlDbType.DateTime),
					new SqlParameter("@endDate", SqlDbType.DateTime),
					new SqlParameter("@jcBeginDate", SqlDbType.DateTime),
					new SqlParameter("@jcEndDate", SqlDbType.DateTime),
					new SqlParameter("@resultType", SqlDbType.Int,8),
					new SqlParameter("@rType1Times", SqlDbType.Int,8),
					new SqlParameter("@rType2Times", SqlDbType.Int,8),
					new SqlParameter("@rType3Times", SqlDbType.Int,8),
