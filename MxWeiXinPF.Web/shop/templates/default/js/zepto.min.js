...
utils.namespace("mobile.o2ocn.addrList"), utils.namespace("mobile.o2ocn.addrchoose"), function () {
    ...
    a.init = function () {
        ...
        b.forEach(function (b, h) {
            ...
            }), 1 == b.pList.length ? (g.key || (g.key = b.pName + ":" + b.pList[0],
            g.index = h, g.propName = b.pName), a.matchProperty[h] = b.pName + ":" + b.pList[0],
            a.selectedCount++) : f.push(b.pName), e.push(c.replace(/{#index#}/, h).replace(/{#pName#}/g, b.pName).replace(/{#pList#}/, i.join("")))
        }), a.errorMsg = "请选择" + f.join("/"),
        $("#prop-list").html(e.join("")), a.pNodeList = $(".mod_property"), g.key && a.loopProp(g.key, g.index, g.propName), g = null
...
utils.namespace("mobile.o2ocn.address"), function () {
    ...
    a.init = function () {
       ...
       // alert("修改商品数量1:b"+b);
        ...
        var a = 0,
			b = this;
        b.selectItems.number > 0 && $.each(b.selectItems.items, function (c, d) {
            var _dIndex = d.attr("index");
             
            a += parseFloat(d.attr("price")) * b.itemCache[_dIndex-1].bc
        }), $("#total").text((a / 100).toFixed(2))
    },
    a.emptyCartIfNone = function (a) {
        a = a ? a : "content", getCmdyCount(), $("#" + a).html("<div class='qb_gap qb_tac qb_pt10' style='padding:70px 0 5px;margin-bottom: 0px;'><img src='/shop/templates/default/images/icon_cart_empty.png' width='81' class='qb_mb10'><p class='qb_fs_xl mod_color_comment'>你的购物车空空如也哦</p></div> <div class='qb_tac qb_gap'><a href='" + window.basePath + "/shop/index.aspx?wid=" + $("#wid").val() + "&openid=" + $("#openid").val() + "' class='mod_btn'>去逛逛</a></div>")
    ...
    a.init = function () {
        ...
        if (window.totalStock > 0 && window.sku.length > 0 && !this.buyProperty) return utils.showBubble(this.errorMsg), void 0;
        var selectArr = this.buyProperty.split('|');
        var selectId = "";
        for (var _sIndex in selectArr) {
            selectId += window.availSku[selectArr[_sIndex]].pid + "|";
        ...
        var a = this,
			b = {
			    ...
			    productid: $("#ic").val(),
			    attr: this.buyProperty+"",
			    mid: selectId,// window.availSku[this.buyProperty].pid,
			    totprice:$("#totprice").val(),
			    bc: this.buyNum,
			    t: (new Date).getTime()
			};
