...
{
    public partial class Search : ShopBasePage
    {
        override protected void OnInit(EventArgs e)
        {
            ...
            serverPath = MyCommFun.GetRootPath() + "/shop/templates/" + templateFileName + "/search.html";
            ShopTemplateMgr template = new ShopTemplateMgr("/shop/templates/" + templateFileName, serverPath, wid);
            template.tType = TemplateType.Search;
