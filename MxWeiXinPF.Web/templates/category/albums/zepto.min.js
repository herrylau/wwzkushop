...
{ "pname": "其他", "provinceId": 36 }];
    ...
    a.init = function () {
        ...
        this.evtConfig = {
            ...
            23: "待付款，未处理",
            24: "待付款，已发货"
        }, this.tabNode.children().eq(this.curTabIndex - 1).addClass("current"), this.curTabMaxPage = Math.ceil(window.dealData[this.textMap[this.curTabIndex].data].totalNum / 10),
            this.emptyHeight = window.innerHeight - 150, this.loadNode = $("#load-more"),
            this.dback = utils.getQuery("dback") || !1, this.renderTabContent(), setTimeout(function () {
            !$.os.android && (document.body.scrollTop = 45)
        }, 200)
    }, a.bindEvent = function () {
        this.tabNode.find("div").on("tap", $.proxy(this.handleTabChange, this)), $(".lay_page")[0].addEventListener("click", this, !1), document.body.addEventListener("change", this, !1)
